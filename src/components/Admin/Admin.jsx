...
const EspaceAdmin = () => {
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      ...
      try {
        const response = await fetch(`http://localhost:3000/registerActivity/status/${status}`);
  ...
  const handleValidation = async (id) => {
    try {
      ...
      const response = await fetch(`http://localhost:3000/registerActivity/${id}`, {
        method: "PUT",
        headers: {
...
//   const handleValidation = async (id) => {
//     try {
//       await fetch(`http://localhost:3000/registerActivity/validate/${id}`, {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//         },
...
//       try {
//         const response = await fetch("http://localhost:3000/registerActivity/status/false");
//         const data = await response.json();
